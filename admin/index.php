...
<head>
    <title>Traffic Police Admin Login</title>
    <!--Meta tags start-->
    <meta charset="UTF-8">
            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body animated fadeIn">
                        ...
                        <h5 class="card-title text-center">Traffic Police Admin Log In</h5>
                        <!--Warning msg start-->
				...
				<?php } ?>
                        <form class="form-signin" action="login_action" method="POST">
                            <div class="form-label-group">
                                <input type="email" id="inputEmail" name="admin_email" class="form-control" placeholder="Enter your Email address">
                            </div>
                            <div class="form-label-group">
                                <input type="password" id="inputPassword" name="admin_password" class="form-control" placeholder="Enter your Password">
                            </div>
