				...
				<?php } ?>
                        ...
                        <form class="form-signin" action="login_action" method="POST">
                            <div class="form-label-group">
                                <input type="text" id="inputDL" class="form-control" placeholder="Enter your Driving License Number" name="license_id">
                            </div>
                            <div class="form-label-group">
                                <input type="password" id="inputPassword" class="form-control" placeholder="Enter your Password" name="driver_password">
                            </div>
                            <button class="btn btn-lg btn-block text-uppercase" type="submit">Log in</button>
                            <hr class="my-4">
                            <h6 style="text-align: center; text-decoration: none;"><span class="ml-2 homelink"><a href="../index.php"><i class="fas fa-home"></i> Home</a></span></h6>
                        </form>
                    </div>
                </div>
            </div>
