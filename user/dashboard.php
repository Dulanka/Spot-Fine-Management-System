                    ...
                    <div data-toggle="tooltip" data-placement="bottom" data-title="Total fine amount you paid" class="dashcounter color-three p-4 box-hover">
                        <p>
                            <i class="fas fa-coins"></i>
                                ...
                                include ("../connection.php");
                                $license_id = $_SESSION['license_id'];
                                $result = mysqli_query($conn,"SELECT points From driver WHERE license_id='$license_id'");
                                $row = mysqli_fetch_array($result);
                                $points = $row[0];
                                echo '<h3 class="counter">'.$points.'</h3>';
                            ?>
                      
                        <p class="dashcount-name">Points Available</p>
                    </div>
                </div>
