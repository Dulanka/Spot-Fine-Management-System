...
<div class="topnavbar">
    ...
    <ul class="topnavbar-nav">
        ...
        <li class="topnav-item">
            <img src="../assets/img/logo_text.png" alt="STFMS logo" class="logo logo-light">
        </li>
    </ul>
    <!-- end topnav left -->
    <!-- topnav right -->
    <ul class="topnavbar-nav topnav-right">
        <li class="topnav-item">
            <div class="mydropdown">
                <p class="mydropdown-toggle pro-drop" data-toggle="user-menu">Account Settings <i class="fas fa-caret-down mydropdown-toggle" data-toggle="user-menu"></i></p>
