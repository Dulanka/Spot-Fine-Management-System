...
<head>
    <title>Login | Motor Traffic Department</title>
    <!--Meta tags start-->
    <meta charset="UTF-8">
            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body animated fadeIn">
                        <h1 class="card-icon"><i class="fas fa-building"></i></h1>
                        <h5 class="card-title text-center">Motor Traffic Department Log In</h5>
                        <!--Warning msg start-->
				...
				<?php } ?>
                        ...
                        <form class="form-signin" action="login_action" method="POST">
                            <div class="form-label-group">
                                <input type="email" id="inputEmail" name="mtd_email" class="form-control" placeholder="Email address">
                            </div>
                            <div class="form-label-group">
                                <input type="password" id="inputPassword" name="mtd_password" class="form-control" placeholder="Password">
                            </div>
                            <button class="btn btn-lg btn-block text-uppercase" type="submit">Log in</button>
                            <hr class="my-4">
                            <h6 style="text-align: center; text-decoration: none;"> <span class="ml-2"><a href="../gov.php"><i class="fas fa-home"></i> Home</a></span></h6>
                        </form>
                    </div>
                </div>
            </div>
