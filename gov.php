...
<head>
    <title>Authorized Login Page</title>
        ...
        <div class="topnavbar animated fadeIn">
            ...
            <ul class="topnavbar-nav">
                <li class="topnav-item">
                    <a href="index.php"><img src="assets/img/logo_text.png" alt="STFMS logo" class="logo logo-light"></a>            
                </li>
            </ul>
            <!-- end topnav left -->
            <!-- topnav right -->
                ...
                <a href="admin/index.php">
                    <div class="col-md-4 box-btn">
                        <i class="fas fa-user-shield"></i>
                            <h5>Click to Traffic Police Admin Login</h5>
                    </div>
                </a>
                <a href="mtd/index.php">
                    <div class="col-md-4 box-btn">
                        <i class="fas fa-building"></i>
                            <h5>Click to Motor Traffic Department Login</h5>
                    </div>
                </a>
                <a href="tpo/index.php">
                    <div class="col-md-4 box-btn">
                        <i class="fas fa-book-reader"></i>
                            <h5>Click to Traffic Police Officer Login</h5>
                    </div>
                </a>    
            </div>
        </div>
            ...
            <div class="container animated fadeIn">
                <div class="row">
                    ...
                    <div class="footer-col">
                        ...
                        <ul>
                            <li><a style="text-transform: lowercase;" href="mailto:sfms@gmail.com" target="_blank"> <i class="fas fa-envelope"></i> sfms@gmail.com</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Navigate to</h4>
